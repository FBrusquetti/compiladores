...
int is_scape(char c){
/*recibe un char y compara con una lista de elementos que pueden venir despues de una barra invertida en un STRING,si no matchea con ninguno
no es un caracter de escape valido
*/
...
void consumir()
// consume los caracters hasta que encuentre un \n o EOF
{
    estado_error=1;
    while(c!='\n' && c!=EOF)
    {
